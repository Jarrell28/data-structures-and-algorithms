...
const validateEmail = (email) => {
  // Solution code here...
  let regex = /^([a-z0-9]+|[a-z0-9]+[.][a-z0-9]+)(@)([a-z0-9]+)(.net|.com|.org)$/i;
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  let regex = /^([0-9][0-9][0-9]|[(][0-9][0-9][0-9][)])([0-9][0-9][0-9]|[0-9][0-9][0-9] | [0-9][0-9][0-9] |-[0-9][0-9][0-9]-|-[0-9][0-9][0-9] | [0-9][0-9][0-9]-| [0-9][0-9][0-9]|[0-9][0-9][0-9]-|-[0-9][0-9][0-9])([0-9][0-9][0-9][0-9])$/
