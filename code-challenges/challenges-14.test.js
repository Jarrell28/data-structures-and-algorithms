...
const detectTicTacToeWin = (board) => {
  ...
  else if ((row1[0] === 'X' && row2[0] === 'X' && row3[0] === 'X') || (row1[0] === 'O' && row2[0] === 'O' && row3[0] === 'O')) {
    return true;
  } else if ((row1[1] === 'X' && row2[1] === 'X' && row3[1] === 'X') || (row1[1] === 'O' && row2[1] === 'O' && row3[1] === 'O')) {
    return true;
  } else if ((row1[2] === 'X' && row2[2] === 'X' && row3[2] === 'X') || (row1[2] === 'O' && row2[2] === 'O' && row3[2] === 'O')) {
    return true;
  }

  else if ((row1[0] === 'X' && row2[1] === 'X' && row3[2] === 'X') || (row1[0] === 'O' && row2[1] === 'O' && row3[2] === 'O')) {
    return true;
  } else if ((row1[2] === 'X' && row2[1] === 'X' && row3[0] === 'X') || (row1[2] === 'O' && row2[1] === 'O' && row3[0] === 'O')) {
    return true;
  }
